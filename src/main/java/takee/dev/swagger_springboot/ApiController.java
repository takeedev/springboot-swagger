...
public class ApiController {
    ...
    @Operation(summary = "ทดสอบ api get request", description = "Api จะตอบกลับเป็นคำว่า Hello World")
    ...
    public ResponseEntity<PostModel> postMethodHeader(
    ...
    public ResponseEntity<Void> postRequestMultipartFile(
